...
analitiques_temps_rai<-Analitica_Temps2(
  dt=dt_variables2 ,  
  grup="HBA1c",
  dataini="dat",
  datasort="datafi",
...
analitiques_temps_jordi<-Analitica_Temps(
  dt=dades_long ,  
  grup="HBA1c",
  dataini="dat",
  datasort="datafi",
...
# aliquem la funcio , dades Jordi R.!


analitiques_temps2<-Analitica_Temps(
  dt=dades_long ,  
  grup="HBA1c",
  dataini="dat",
  datasort="datafi",
...
#i)
fit1 <- coxph(Surv(tstart, tstop, situacio=="TBC") ~ val_7_5+sexe+edat+cluster(idp),data=analitiques_temps2)
summary(fit1)
cox.zph(fit1)
#plot(cox.zph(fit1))
...
fit1b <- coxph(Surv(tstart, tstop, situacio=="TBC") ~ val_7_5+edat+strata(sexe)+cluster(idp),data=analitiques_temps2)
summary(fit1b)
cox.zph(fit1b)

# 
fit2 <- coxph(Surv(tstart, tstop, situacio=="TBC") ~ val+edat+sexe+cluster(idp),data=analitiques_temps)
summary(fit2)
cox.zph(fit2)
sjPlot::tab_model(fit2)

# 
fit2 <- coxph(Surv(tstart, tstop, situacio=="TBC") ~ val+edat+sexe+cluster(idp),data=analitiques_temps2)
summary(fit2)
cox.zph(fit2)
sjPlot::tab_model(fit2)
...
#ii)
fit2 <- coxph(Surv(tstart, tstop, situacio=="TBC") ~ val_8+sexe+edat+cluster(idp),data=analitiques_temps2)
summary(fit2)
cox.zph(fit2)
...
fit2b <- coxph(Surv(tstart, tstop, situacio=="TBC") ~ val_8+edat+strata(sexe)+cluster(idp),data=analitiques_temps2)
summary(fit2b)
cox.zph(fit2b)
...
#iii)
fit3a <- coxph(Surv(tstart, tstop, situacio=="TBC") ~ val_9+sexe+edat+cluster(idp),data=analitiques_temps2)
summary(fit3a)
cox.zph(fit3a)
...
#iv)
fit4a <- coxph(Surv(tstart, tstop, situacio=="TBC") ~ val_9+edat+strata(sexe)+cluster(idp),data=analitiques_temps2)
summary(fit4a)
cox.zph(fit4a)
...
#v)
fit5 <- coxph(Surv(tstart, tstop, situacio=="TBC") ~ val_9+edat_CAT+strata(sexe)+cluster(idp),data=analitiques_temps)
summary(fit5)
cox.zph(fit5)
#plot(cox.zph(fit5))
...
#v)
fit5a <- coxph(Surv(tstart, tstop, situacio=="TBC") ~ val_9+edat_CAT+strata(sexe)+cluster(idp),data=analitiques_temps2)
summary(fit5a)
cox.zph(fit5a)
